...
const REVERA_CONFIG = {
     ...
     // --- Vreme skeniranja pečata (opciono) ---
     // Kad je stampWindowEnabled uključeno, pečat se može dodati SAMO u ovom
     // periodu (po vremenu uređaja kojim osoblje skenira), isto svaki dan.
     // Van tog perioda skener prikazuje poruku umesto da doda pečat.
     stampWindowEnabled: false,
     stampWindowStart: "07:00",         // HH:MM
     stampWindowEnd: "13:00",           // HH:MM
